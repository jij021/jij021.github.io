...
var Airtable = require('airtable');
var base = new Airtable({apiKey: 'keyzO8HNBKPW555xb'}).base('appYidD4KOiOTegE9');

// gets all the books from the table from airtable database -> this has been commented out
